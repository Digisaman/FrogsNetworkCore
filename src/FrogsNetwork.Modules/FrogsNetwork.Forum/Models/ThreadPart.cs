...
public class ThreadPart : ContentPart, IThreadPart
{
    //private readonly IUser _closedBy = new ContentField<IUser>();
    //private readonly PostPart _firstPost = new ContentField<PostPart>();
    //private readonly PostPart _latestPost = new ContentField<PostPart>();

    public IUser ClosedByField { get; set; }
    public PostPart FirstPostField { get; set; }
    public PostPart LatestPostField { get; set; }
